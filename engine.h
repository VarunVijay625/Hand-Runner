...
class Engine {
    private:
        ...
        unique_ptr<Rect> sky1;
        unique_ptr<Circle> sky2;
        unique_ptr<Circle> sky3;
        unique_ptr<Circle> sky4;
        unique_ptr<Circle> sky5;
        unique_ptr<Circle> sky6;
        unique_ptr<Circle> sky7;
